...
func (s *Server) setupRoutes(deps Dependencies) {
	...
	s.app.Post("/mcp/register", mcpHandler.DynamicClientRegister)
 	...
 	if deps.Inscripciones != nil {
  	...
  	s.app.Get("/inscripcion/assets/video1.mp4", ih.ServeVideo1)
  	s.app.Get("/inscripcion/assets/video2.mp4", ih.ServeVideo2)
  	s.app.Get("/inscripcion/assets/video3.mp4", ih.ServeVideo3)
  	s.app.Get("/inscripcion/assets/video4.mp4", ih.ServeVideo4)
  	s.app.Get("/inscripcion/assets/AndresMelo.png", ih.ServeAndresMelo)
  	s.app.Get("/inscripcion/assets/imagen1.png", ih.ServeInstructorPista)
  	s.app.Get("/inscripcion/assets/MapaKartodromo.png", ih.ServeMapaKartodromo)
